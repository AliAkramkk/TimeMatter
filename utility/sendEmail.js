...
const verifyEmail = async (body) => {
  try {
    ...
    const mailOptions = {
      ...
      html: `<p>Hello <strong>${body.username}</strong>, Please click the link below to verify your Time Matter account. If this is not done by you, you can safely ignore this email.</p><a href="http://localhost:3004/successemail/${body.username}/${emailToken}">Verify now</a>`
    };
